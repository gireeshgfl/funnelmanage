...
export default function GroupsPage() {
    const { groups, loading, error, createGroup, feedbackMessage, participants, participantsLoading, fetchParticipants } = useGroups();
                    ...
                    <table className="w-full text-left border-collapse">
                        ...
                        <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                            {loading && !isSubmitting ? (
                                ...
                                <tr>
                                    <td colSpan="2" className="px-6 py-8 text-center text-red-500 dark:text-red-400">
                                ...
                                groups?.map((group) => (
                                    <tr key={group.id || group._id} className="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
