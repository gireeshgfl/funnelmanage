...
import { RequestStudentToSessionSchema } from '@utils/schema/session_schema';
import { handlePost } from '@utils/synchrnousPost';

export async function POST(request) {
    try {
        const result = await handleRequestComprehensive(request, RequestStudentToSessionSchema);
